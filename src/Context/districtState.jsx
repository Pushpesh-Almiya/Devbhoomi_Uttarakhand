...
const [tuoristPlaces , setTuoristPlaces] = useState([
  ...
  return (
    <div>
        <districtContext.Provider value={{tuoristPlaces,setTuoristPlaces,getData,dist}}>{props.children}</districtContext.Provider>
    </div>
  )
}
