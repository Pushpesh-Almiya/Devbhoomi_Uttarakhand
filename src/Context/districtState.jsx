...
const [tuoristPlaces , setTuoristPlaces] = useState([
    ...
    },
    {
      ...
      img : "../images/patalBhuvneshwar.jpg",
  ...
  return (
    <div>
        <districtContext.Provider value={{tuoristPlaces,setTuoristPlaces,dist}}>{props.children}</districtContext.Provider>
    </div>
  )
}
