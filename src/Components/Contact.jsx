...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    setAlert("Please Login first to contact");
    setTimeout(() => {
      setAlert("");
    }, 2000);
    // navigate("/login")
  ...
  return (
    <div className="w-full h-full pt-8 bg-green-100">
      ...
      >
        <div
          className={`p-4 mb-4 text-sm flex justify-center items-center text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 ${
            alert === "" ? "hidden" : ""
          }`}
          role="alert"
        >
        ...
        <div className="flex justify-center items-center">
          ...
          >
            ...
            <textarea
              ...
              className="rounded-md p-2 placeholder-gray-700 bg-transparent border-2 text-black border-black"
            ></textarea>
            {login? <button className={`text-white bg-cyan-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300`}>
              Submit
            </button>:<button className={`text-white bg-red-500 disable px-6 py-3 my-8 mx-auto flex items-center rounded-md`}>
              Submit
            </button>}
          </form>
        </div>
