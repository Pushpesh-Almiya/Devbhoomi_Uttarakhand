  ...
  const [tuoristPlaces, setTuoristPlaces] = useState([
    {
      ...
      firstPara:
        "Kasar devi is a village near Almora, Uttarakhand. It is known for the Kasar Devi temple, a Devi temple, dedicated to Kasar Devi, afterwhom the place is also named. The temple structure dates to the 2nd century CE. Swami Vivekananda visited Kasar Devi in 1890s, andnumerous western seeker, Sunyata Baba Alfred Sorensen and LamaAnagarika Govinda.",
      secondPara:
        "It's believed that this temple is positioned onthe earth's Van Allen Belt. The region surrounding the Kasar DeviTemple has an enormous geomagnetic field, thanks to gaps in bands ofradiation. As a result, Kasar Devi is endowed with a cosmic energysimilar to that of Stonehenge in UK and \"Machu Pichu in Peru\" Also known as Hippie Hill or Crank's Ridge, Kasar Devi Temple complex hasalways been a melting pot of art, spiritualism and poetry. SingerBob Dylan and actor Uma Thurman, have made this popular and todayKasar Devi continues to attract folks looking for answers to life'schallenging questions. The temple hosts the annual Kasar Devi Fairon Kartik Poornima (November-December).",
    },
    {
      id: 2,
      name: "Nanda Devi",
    ...
    },
    {
      ...
      firstPara:
        "Golu Devata is a deity of the Kumaoni community of India.The Chitai Golu devta temple is the most celebrated temple dedicated to the deity and is about 4 km (2.5 mi) from the main gate of Binsar wildlife sanctuary & about 10 km (6.2 mi) from Almora.",
      secondPara:
    ...
    },
    {
      ...
      firstPara:
        "Jageshwar is a Hindu pilgrimage town near Almora. It is one of the Dhams (pilgrimage region) in the Shaivism tradition. The site is protected under Indian laws, and managed by the Archaeological Survey of India (ASI). It includes Dandeshwar Temple, Chandi-ka-Temple, Jageshwar Temple, Kuber Temple, Mritunjaya Temple, Nanda Devi or Nau Durga, Nava-grah temple, a Pyramidal shrine, and Surya Temple. The site celebrates the Jageshwar Monsoon Festival during the Hindu calendar month of Shravan (overlaps with July-August) and the annual Maha Shivratri Mela (Shivratri festival), which takes place in early spring.",
      secondPara:
    ...
    },
    {
      ...
      firstPara:
        " Ranikhet is ideal for those looking to escape the city life's hustle and bustle. This charming little town is located in Uttarakhand's Kumaon region, surrounded by beautiful mountains and valleys. There are plenty of tourist spots in Ranikhet, such as Golucho Lake and Chaubatia Gardens. Ranikhet is a hill station and cantonment town, . It is the home of the Military Hospital, Kumaon Regiment (KRC) and Naga Regiment and is maintained by the Indian Army.",
      secondPara:
        "Ranikhet is at an altitude of 1,869 metres (6,132 ft) above sea level, within sight of the western peaks of the Himalayas. Ranikhet is a Class IV town with a civic status of a Cantonment board. Rani Jheel is an artificial lake and one of the popular tourist spot in Ranikhet. This small lake was initially constructed by the cantonment board of Indian army for the purpose of rainwater harvesting but now primarily used for boating. Perched at an altitude of 2,500 meters, the lake has now become one of the iconic landmarks of the region. The place exuberates a calmness and serenity that will surely capture nature lover's imagination.",
    },
    {
      id: 6,
      ...
      firstPara:
        "Katarmal is a remote village located in Kumaon Division.Katarmal is located at a distance of 1.5 km from Kosi village and 12 km from the district centre, Almora and 70 km from Nainital. Located at a height of 2116 meters above sea level, it is well connected by road, 30 km away from Khairna, Garampani (Nainital, Haldwani, Coordinates: 29°29'39'N 79°28'46'E) & 33 km from Ranikhet and Kausani the nearest connecting point being near Kosi village. The G.B. Pant Institute of Himalayan Environment and Development, established in 1988 serves as a nodal agency for research and development and was established here by Government of India.",
    ...
    },
    {
      ...
      firstPara:
        "Dunagiri is a historic area in Almora. Dunagiri is known as the birthplace of modern-day Kriya Yoga due to the fact that Lahiri Mahasaya was initiated into Kriya Yoga by Mahavatar Babaji at this site.",
      secondPara:
    ...
    },
    {
      ...
      firstPara:
        "Mount Abbott is a mountain in India . It is located in the Champawat district and state of the State of Uttarakhand , in the northern part of the country, 290 km east of New Delhi , the capital of the country. Abbott Mount is 2,111 meters above sea level, or 406 meters above the surrounding terrain  . Its foothills are about 14.5 kilometers wide.",
      secondPara:
        "The land around Abbott Mount is mountainous in the north, but in the south it is hilly. The highest area in the area has a height of 2,468 meters and is 13.8 km northeast of Abbott Mount. There are about 134 people per square kilometer around Abbott Mount, quite densely populated. The nearest larger town is Lohaghāt , 3.1 km south of Abbott Mount. Abbott Mount is almost covered in mixed forest .",
    },
    {
      id: 39,
    ...
    },
    {
      ...
      firstPara:
        "Rajaji National Park is an Indian national park and tiger reserve  that encompasses the Shivaliks, near the foothills of the Himalayas. It is spread over 820 km and includes three districts of Uttarakhand: Haridwar, Dehradun and Pauri Garhwal. In 1983, three wildlife sanctuaries in the area namely, Chilla, Motichur and Rajaji were merged into one.",
      secondPara:
    ...
    },
    {
      ...
      firstPara:
        "Rishikesh, also spelt as Hrishikesh, is a city near Dehradun in Dehradun district of the Indian state Uttarakhand. It is situated on the right bank of the Ganges River and is a pilgrimage town for Hindus, with ancient sages and saints meditating here in search of higher knowledge. There are numerous temples and ashrams built along the banks of the river. It is known as the \"Gateway to the Garhwal Himalayas\" and \"Yoga Capital of the World\".  The city has hosted the annual \"International Yoga Festival\" on the first week of March since 1999. Rishikesh is a vegetarian-only and alcohol-free city",
      secondPara:
