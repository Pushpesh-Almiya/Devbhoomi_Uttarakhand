    ...
    const [districtDetails, setDistrictDetails]=useState([
      {
        ...
        about:"Almora is a municipal board and a cantonment town in the state of Uttarakhand, India. It is the administrative headquarters of Almora district. Almora is located on a ridge at the southern edge of the Kumaon Hills of the Himalaya range. The Koshi (Kaushiki) and Suyal (Salmale) rivers flow along the city and snow-capped Himalayas can be seen in the background.Almora was founded in 1568. by King Kalyan Chand; however, there are accounts of human settlements in the hills and surrounding region in the Hindu epic Mahabharata.(8th and 9th century BCE). Almora was the seat of Chand kings that ruled over the Kumaon Kingdom. It is considered the cultural heart of the Kumaon region of Uttarakhand.According to the provisional results of the 2019 national census of India, Almora had a population of about 179,000. Nestled within higher peaks of the Himalaya, Almora enjoys a year-round mild temperate climate. The town is visited by thousands of tourists annually from all over the world There are 11 blocks (i.e. VikashKhand) in Almora district.",
        history:"Almora got its name from Bhilmora, a kind of sorrel (although some have tried to derive it from Berberis \"kilmora\"), a short plant commonly found there which was used for washing the utensils of the sun temple at Katarmal. The people bringing the Bhilmora/kilmora were called Bhilmori/Kilmori and later \"Almori\" and the place came to be known as \"Almora\".When king Bhishm Chand laid the foundation of the town, he had initially named it Alamnagar. Prior to that, Almora was known as 'Rajapur' during the early phase of Chand rule.The name 'Rajpur' is also mentioned over a number of ancient copper plates. There is still a place called Rajpur in Almora."
      },
      {
        name:"bageshwar",
        ...
        about:"Champawat district is a district of Uttarakhand state in northern India. The town of Champawat is the administrative headquarters. The district of Champawat constituted in the year 1997. The district is divided into five tehsils: Barakot, Lohaghat, Pati, Purnagiri, and Champawat. There is 2 Sub Tehsil: Pulla and Munch. The largest and the main city of the district is Tanakpur.Champawat district is part of the eastern Kumaon division of Uttarakhand. It is bounded on the north by Pithoragarh district, on the east by Nepal, on the south by Udham Singh Nagar district, on the west by Nainital district, and on the northwest by Almora district.As of 2011 it is the second least populous of the 13 districts of Uttarakhand, after Rudraprayag.",
        ...
        about:"Tehri Garhwal is a district in the hill state of Uttarakhand, India. Its administrative headquarters is at New Tehri. The district has a population of 618, 931 (2011 census), a 2.35% increase over the previous decade. It is surrounded by Rudraprayag District in the east, Dehradun District in the west, Uttarkashi District in the north, and Pauri Garhwal District in the south. Tehri Garhwal is a part of the Himalayas.",
        ...
        history:"Rudraprayag district is located at 30.28°N 78.98°E. It has an average elevation of 895 metres (2,936 feet).Many of the newer buildings and particularly the Sangam (confluence) area was severely damaged in the 2013 Uttarakhand floods. A footbridge over the Mandakini river, and also a road bridge 6 km downstream at Raitoli was washed away. The layout of the Sangam has altered significantly. The road along the Mandakini valley, leading to Kedarnath, was damaged at many points."
      },
    ])
