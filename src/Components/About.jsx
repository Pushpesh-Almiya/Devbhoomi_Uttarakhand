    ...
    <div className="pt-8">
      ...
      <div className="p-4 bg-green-100">
        <p className="py-2 md:text-xl">
          ...
          Uttarakhand. I have created this platform to share my adventures, insights, and travel experiences with fellow wanderers.
        </p>
        <h1 className="inline-block border-b-2 border-gray-500 text-2xl">About Me:</h1>
        <p className="py-2 md:text-xl">
          I am a travel enthusiast, storyteller, and nature lover. My love for
          exploration and curiosity about the world led me to embark on
          countless solo adventures. With every trip, I've found solace,
        ...
        <p className="py-2 md:text-xl">
          If you are a fellow solo traveler or someone considering embarking on
        ...
        <p className="font-bold text-xl py-2">Happy Trails,</p>
