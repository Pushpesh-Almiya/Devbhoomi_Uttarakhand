...
<button type="button" className="text-white bg-blue-700 px-5 py-2 mx-auto hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-300 font-medium rounded-full text-2xl text-center font-signature mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900" onClick={()=>{navigate('/districts')}}>Uttarakhand Visit</button>

<iframe className='mx-auto w-full  mt-3 h-80 md:h-screen md:mt-5 border-0' title='uttarakhand' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2414247.38421972!2d77.93417296220248!3d30.027832418901816!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3909dcc202279c09%3A0x7c43b63689cc005!2sUttarakhand!5e0!3m2!1sen!2sin!4v1690441601017!5m2!1sen!2sin"  allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
    </div>
    </>
  )
}
